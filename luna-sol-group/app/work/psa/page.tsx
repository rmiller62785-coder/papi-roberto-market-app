        ...
        <section className="case-page-hero">
          <div className="shell case-hero-grid">
            <div className="case-title">
              <Link className="breadcrumb" href="/">Home</Link><span aria-hidden="true">/</span><span>Featured work</span>
          ...
          <div className="shell case-meta">
            ...
            <div><span>Operating arc</span><strong>~14m peak → 11m official</strong></div>
        ...
        <section className="section results-section">
          <div className="shell">
            ...
            <div className="results-grid">
              <article><span>Backlog recovery</span><strong>~14m <i>→</i> 11m</strong><p>Peak reported in June to the July 14 official checkpoint.</p></article>
